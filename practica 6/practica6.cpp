...
int main()
{
	...
	dadoanimales = Texture("Textures/dado_animalesjpg.jpg");
	dadoanimales.LoadTextureA();
	...
	Dado_A = Model();
	Dado_A.LoadModel("Models/dadoAobj.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(2.0f, 9.0f, 8.0f));
